package tw.com.sung.noel.scrollerlistview.topheaderlayout;
...
import static tw.com.sung.noel.scrollerlistview.scrollerlistview.ScrollerListView.TOP_HEADER;
import static tw.com.sung.noel.scrollerlistview.bottomlistview.BottomListView.LEFT;
import static tw.com.sung.noel.scrollerlistview.bottomlistview.BottomListView.NONE;
...
public class TopHeaderLayout extends LinearLayout implements View.OnTouchListener {
     ...
     */
    private
    @BottomListView.scrollDirection
    int scrollDirection = NONE;


    public TopHeaderLayout(Context context) {
        super(context);
    ...
    public TopHeaderLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TopHeaderLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
